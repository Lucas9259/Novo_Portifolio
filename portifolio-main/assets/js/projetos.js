  ...
  section.innerHTML = `<header>
    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          <h3>Site Star Wars</h3>
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/Site StarWars.gif"
              alt="Gif Site Star Wars."
            />
            <div class="buttons">
              <a href="https://github.com/Lucas9259/Site-do-Star_Wars" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://site-do-star-wars.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
          Site de compras estilo Star Wars: escolha seu equipamento com base no filme e jogo. May the Force be with you!
          </p>
          <p>HTML - CSS - JS </p>
        </div>
        <div class="card">
