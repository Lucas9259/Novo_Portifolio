      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/ProjetoCalculadora.gif"
              alt="GIF do projeto Calculadora."
            />
            <div class="buttons">
              <a href="https://github.com/Lucas9259/Calculadora" target="_blank" title="Repositório no Github">
                <svg
        ...
        <div class="card">
          ...
          <div class="img-wrapper">
            ...
            <div class="buttons">
              <a href="https://github.com/Lucas9259/GeradorDeEmoji" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://geradordeemoji.netlify.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>HTML - CSS - JS - Framewoks - Blibliotecas </p>
        </div>
        ...
        <div class="card">
          <h3>Pokedex</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/pokedex.gif" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/Lucas9259/Pokedex" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://pokedexlive.netlify.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          <h3>Site Empresa Construção Civil</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/Vll_Eletrica.gif" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/Lucas9259/VLLEletrica" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://siteempresavll.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>  " Site Criado Para a Empresa em que Trabalho , Desenvolvido De uma forma Simples , Para reconhecimento do trabalho e  entrar em contato !! . " </p>
          <p>HTML - CSS - JS  </p>
        </div>
